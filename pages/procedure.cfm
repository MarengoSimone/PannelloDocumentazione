...
<html>
	...
	<body>
		...
		<a href="modifica_procedure.cfm?tipo=export&procedureid=0"> <input type="button" class="btn btn-success" value="Esporta in un file CSV"></a>
		<a href="modifica_procedure.cfm?tipo=inport&procedureid=0"> <input type="button" class="btn btn-success" value="Inporta nel DB"></a>
	</body>
</html>